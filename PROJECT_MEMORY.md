...
- **Integración de Plano Interactivo de Stands en la Landing Page (`App.jsx` & `InteractiveMap.jsx`):**
  ...
  - **Tarjeta Emergente en Hover (Solo Logo):** Se eliminaron todos los textos, nombres, badges y leyendas de la tarjeta flotante de *hover*, dejando exclusivamente la imagen del logotipo limpia y a gran tamaño (hasta `280px`).
